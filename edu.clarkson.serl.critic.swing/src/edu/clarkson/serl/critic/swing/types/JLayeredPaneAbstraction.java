 ...
 *
 */
public class JLayeredPaneAbstraction extends JComponentAbstraction {
	public static final String TYPE =  "javax.swing.JLayeredPane";
	public static final Value DEFAULT_VALUE = AbstractValue.fromObject(TYPE);

	public JLayeredPaneAbstraction() {
		super(DEFAULT_VALUE);
	}

	public JLayeredPaneAbstraction(Value sootValue) {
		super(sootValue);
	}

	public JLayeredPaneAbstraction(Value sootValue, boolean open, boolean mutable) {
