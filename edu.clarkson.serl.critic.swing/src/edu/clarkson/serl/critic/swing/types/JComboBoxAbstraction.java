 ...
 *
 */
public class JComboBoxAbstraction extends JComponentAbstraction {
	public static final String TYPE = "javax.swing.JComboBox";
	public static final Value DEFAULT_VALUE = AbstractValue.fromObject(TYPE);

	public JComboBoxAbstraction() {
		super(DEFAULT_VALUE);
	}

	public JComboBoxAbstraction(Value sootValue) {
		super(sootValue);
	}

	public JComboBoxAbstraction(Value sootValue, boolean open, boolean mutable) {
