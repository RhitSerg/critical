 ...
 *
 */
public class JViewportAbstraction extends JComponentAbstraction {
	public static final String TYPE = "javax.swing.JViewport";
	public static final Value DEFAULT_VALUE = AbstractValue.fromObject(TYPE);
	
	public JViewportAbstraction() {
		super(DEFAULT_VALUE);
	}

	public JViewportAbstraction(Value sootValue) {
		super(sootValue);
	}

	public JViewportAbstraction(Value sootValue, boolean open, boolean mutable) {
