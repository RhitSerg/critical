 ...
 *
 */
public class JTextFieldAbstraction extends JComponentAbstraction {
	public static final String TYPE = "javax.swing.JTextField";
	public static final Value DEFAULT_VALUE = AbstractValue.fromObject(TYPE);

	public JTextFieldAbstraction() {
		super(DEFAULT_VALUE);
	}

	public JTextFieldAbstraction(Value sootValue) {
		super(sootValue);
	}

	public JTextFieldAbstraction(Value sootValue, boolean open, boolean mutable) {
