 ...
 *
 */
public class JLabelAbstraction extends JComponentAbstraction {
	public static final String TYPE = "javax.swing.JLabel";
	public static final Value DEFAULT_VALUE = AbstractValue.fromObject(TYPE);
	
	public JLabelAbstraction() {
		super(DEFAULT_VALUE);
	}
	
	public JLabelAbstraction(Value sootValue) {
		super(sootValue);
	}
	
	public JLabelAbstraction(Value sootValue, boolean open, boolean mutable) {
