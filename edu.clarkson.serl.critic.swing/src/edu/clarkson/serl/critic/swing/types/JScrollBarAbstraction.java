 ...
 *
 */
public class JScrollBarAbstraction extends JComponentAbstraction {
	public static final String TYPE = "javax.swing.JScrollBar";
	public static final Value DEFAULT_VALUE = AbstractValue.fromObject(TYPE);

	public JScrollBarAbstraction() {
		super(DEFAULT_VALUE);
	}

	public JScrollBarAbstraction(Value sootValue) {
		super(sootValue);
	}

	public JScrollBarAbstraction(Value sootValue, boolean open, boolean mutable) {
