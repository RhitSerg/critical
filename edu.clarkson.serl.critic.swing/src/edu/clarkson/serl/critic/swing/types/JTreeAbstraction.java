 ...
 *
 */
public class JTreeAbstraction extends JComponentAbstraction {
	public static final String TYPE = "javax.swing.JTree";
	public static final Value DEFAULT_VALUE = AbstractValue.fromObject(TYPE);

	public JTreeAbstraction() {
		super(DEFAULT_VALUE);
	}

	public JTreeAbstraction(Value sootValue) {
		super(sootValue);
	}
	
	public JTreeAbstraction(Value sootValue, boolean open, boolean mutable) {
