 ...
 *
 */
public class JProgressBarAbstraction extends JComponentAbstraction {
	public static final String TYPE = "javax.swing.JProgressBar";
	public static final Value DEFAULT_VALUE = AbstractValue.fromObject(TYPE);

	public JProgressBarAbstraction() {
		super(DEFAULT_VALUE);
	}

	public JProgressBarAbstraction(Value sootValue) {
		super(sootValue);
	}

	public JProgressBarAbstraction(Value sootValue, boolean open, boolean mutable) {
