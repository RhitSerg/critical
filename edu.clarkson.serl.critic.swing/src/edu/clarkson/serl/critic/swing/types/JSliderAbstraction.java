 ...
 *
 */
public class JSliderAbstraction extends JComponentAbstraction {
	public static final String TYPE = "javax.swing.JSlider";
	public static final Value DEFAULT_VALUE = AbstractValue.fromObject(TYPE);

	public JSliderAbstraction() {
		super(DEFAULT_VALUE);
	}

	public JSliderAbstraction(Value sootValue) {
		super(sootValue);
	}

	public JSliderAbstraction(Value sootValue, boolean open, boolean mutable) {
