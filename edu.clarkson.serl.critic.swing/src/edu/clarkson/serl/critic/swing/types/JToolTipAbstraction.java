 ...
 *
 */
public class JToolTipAbstraction extends JComponentAbstraction {
	public static final String TYPE = "javax.swing.JToolTip";
	public static final Value DEFAULT_VALUE = AbstractValue.fromObject(TYPE);

	public JToolTipAbstraction() {
		super(DEFAULT_VALUE);
	}

	public JToolTipAbstraction(Value sootValue) {
		super(sootValue);
	}

	public JToolTipAbstraction(Value sootValue, boolean open, boolean mutable) {
