 ...
 *
 */
public class JTableAbstraction extends JComponentAbstraction {
	public static final String TYPE = "javax.swing.JTable";
	public static final Value DEFAULT_VALUE = AbstractValue.fromObject(TYPE);

	public JTableAbstraction() {
		super(DEFAULT_VALUE);
	}

	public JTableAbstraction(Value sootValue) {
		super(sootValue);
	}

	public JTableAbstraction(Value sootValue, boolean open, boolean mutable) {
