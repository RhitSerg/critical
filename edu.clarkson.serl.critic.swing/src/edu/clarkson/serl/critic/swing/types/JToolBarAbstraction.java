 ...
 *
 */
public class JToolBarAbstraction extends JComponentAbstraction {
	public static final String TYPE = "javax.swing.JToolBar";
	public static final Value DEFAULT_VALUE = AbstractValue.fromObject(TYPE);

	public JToolBarAbstraction() {
		super(DEFAULT_VALUE);
	}

	public JToolBarAbstraction(Value sootValue) {
		super(sootValue);
	}

	public JToolBarAbstraction(Value sootValue, boolean open, boolean mutable) {
