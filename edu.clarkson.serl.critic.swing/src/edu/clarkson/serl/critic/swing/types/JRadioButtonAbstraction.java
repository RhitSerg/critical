 ...
 *
 */
public class JRadioButtonAbstraction extends JComponentAbstraction {
	public static final String TYPE = "javax.swing.JRadioButton";
	public static final Value DEFAULT_VALUE = AbstractValue.fromObject(TYPE);
	
	public JRadioButtonAbstraction() {
		super(DEFAULT_VALUE);
	}

	public JRadioButtonAbstraction(Value sootValue) {
		super(sootValue);
	}
	
	public JRadioButtonAbstraction(Value sootValue, boolean open, boolean mutable) {
