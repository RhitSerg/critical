 ...
 *
 */
public class JMenuBarAbstraction extends JComponentAbstraction {
	public static final String TYPE = "javax.swing.JMenuBar";
	public static final Value DEFAULT_VALUE = AbstractValue.fromObject(TYPE);

	public JMenuBarAbstraction() {
		super(DEFAULT_VALUE);
	}

	public JMenuBarAbstraction(Value sootValue) {
		super(sootValue);
	}

	public JMenuBarAbstraction(Value sootValue, boolean open, boolean mutable) {
