 ...
 *
 */
public class JSeperatorAbstraction extends JComponentAbstraction {
	public static final String TYPE = "javax.swing.JSeperator";
	public static final Value DEFAULT_VALUE = AbstractValue.fromObject(TYPE);

	public JSeperatorAbstraction() {
		super(DEFAULT_VALUE);
	}

	public JSeperatorAbstraction(Value sootValue) {
		super(sootValue);
	}

	public JSeperatorAbstraction(Value sootValue, boolean open, boolean mutable) {
