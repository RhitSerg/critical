 ...
 *
 */
public class JEditorPaneAbstraction extends JComponentAbstraction {
	public static final String TYPE = "javax.swing.JEditorPane";
	public static final Value DEFAULT_VALUE = AbstractValue.fromObject(TYPE);

	public JEditorPaneAbstraction() {
		super(DEFAULT_VALUE);
	}

	public JEditorPaneAbstraction(Value sootValue) {
		super(sootValue);
	}

	public JEditorPaneAbstraction(Value sootValue, boolean open, boolean mutable) {
