 ...
 */
public class JFileChooserAbstraction extends JComponentAbstraction {
	public static final String TYPE = "javax.swing.JFileChooser";
	public static final Value DEFAULT_VALUE = AbstractValue.fromObject(TYPE);
	
	public JFileChooserAbstraction() {
		super(DEFAULT_VALUE);
	}

	public JFileChooserAbstraction(Value sootValue) {
		super(sootValue);
	}

	public JFileChooserAbstraction(Value sootValue, boolean open, boolean mutable) {
