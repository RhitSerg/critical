 ...
 *
 */
public class JTableHeaderAbstraction extends JComponentAbstraction {
	public static final String TYPE = "javax.swing.JTableHeader";
	public static final Value DEFAULT_VALUE = AbstractValue.fromObject(TYPE);

	public JTableHeaderAbstraction() {
		super(DEFAULT_VALUE);
	}

	public JTableHeaderAbstraction(Value sootValue) {
		super(sootValue);
	}

	public JTableHeaderAbstraction(Value sootValue, boolean open, boolean mutable) {
