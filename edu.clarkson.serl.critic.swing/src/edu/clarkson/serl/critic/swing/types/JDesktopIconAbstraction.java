 ...
 *
 */
public class JDesktopIconAbstraction extends JComponentAbstraction {
	public static final String TYPE = "javax.swing.JDesktopIcon";
	public static final Value DEFAULT_VALUE = AbstractValue.fromObject(TYPE);
	
	public JDesktopIconAbstraction() {
		super(DEFAULT_VALUE);
	}
	public JDesktopIconAbstraction(Value sootValue) {
		super(sootValue);
	}
	
	public JDesktopIconAbstraction(Value sootValue, boolean open, boolean mutable) {
