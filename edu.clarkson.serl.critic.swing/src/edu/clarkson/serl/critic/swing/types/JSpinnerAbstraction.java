 ...
 *
 */
public class JSpinnerAbstraction extends JComponentAbstraction {
	public static final String TYPE = "javax.swing.JSpinner";
	public static final Value DEFAULT_VALUE = AbstractValue.fromObject(TYPE);

	public JSpinnerAbstraction() {
		super(DEFAULT_VALUE);
	}
	
	public JSpinnerAbstraction(Value sootValue) {
		super(sootValue);
	}

	public JSpinnerAbstraction(Value sootValue, boolean open, boolean mutable) {
