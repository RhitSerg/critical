 ...
 *
 */
public class JPopupMenuAbstraction extends JComponentAbstraction {
	public static final String TYPE = "javax.swing.JPopupMenu";
	public static final Value DEFAULT_VALUE = AbstractValue.fromObject(TYPE);
	
	public JPopupMenuAbstraction() {
		super(DEFAULT_VALUE);
	}

	public JPopupMenuAbstraction(Value sootValue) {
		super(sootValue);
	}

	public JPopupMenuAbstraction(Value sootValue, boolean open, boolean mutable) {
