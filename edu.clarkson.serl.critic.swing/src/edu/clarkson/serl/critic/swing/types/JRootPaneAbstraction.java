 ...
 *
 */
public class JRootPaneAbstraction extends JComponentAbstraction {
	public static final String TYPE = "javax.swing.JRootPane";
	public static final Value DEFAULT_VALUE = AbstractValue.fromObject(TYPE);

	public JRootPaneAbstraction() {
		super(DEFAULT_VALUE);
	}

	public JRootPaneAbstraction(Value sootValue) {
		super(sootValue);
	}

	public JRootPaneAbstraction(Value sootValue, boolean open, boolean mutable) {
