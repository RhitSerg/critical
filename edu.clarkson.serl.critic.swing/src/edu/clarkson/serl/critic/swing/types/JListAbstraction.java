 ...
 *
 */
public class JListAbstraction extends JComponentAbstraction {
	public static final String TYPE = "javax.swing.JList";
	public static final Value DEFAULT_VALUE = AbstractValue.fromObject(TYPE);

	public JListAbstraction() {
		super(DEFAULT_VALUE);
	}

	public JListAbstraction(Value sootValue) {
		super(sootValue);
	}

	public JListAbstraction(Value sootValue, boolean open, boolean mutable) {
