...
/**
 * Use this to run a {@link Job}  as a part of PSF framework.
 *
 * @author <a href="http://clarkson.edu/~rupakhcr">Chandan R. Rupakheti</a> (rupakhcr@clarkson.edu)
 */
public abstract class AbstractCriticJob extends Job {

	/**
	 * Creates a new instance of the class AbstractCriticJob
	 * 
	 * @param name
	 */
	public AbstractCriticJob(String name) {
		super(name);
